...
router.get('/projects', function(req, res, next) {
  var urlApi = "https://capsule-exams.herokuapp.com/api/capsule/projects";
  request(urlApi, function(error, response, body) {
    body = JSON.parse(body);
    res.json({result: true, projects: body.projects});
  });
});
...
router.delete('/myprojects/:idproject', function(req, res, next) {
  projectModel.deleteOne({idproject: req.params.idproject},
